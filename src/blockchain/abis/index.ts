...
import AssetRegistryABI from './IAssetRegistry.json';
import TransactionOrchestratorABI from './ITransactionOrchestrator.json';
...
export const ABIs = {
  ...
  TransactionOrchestrator: TransactionOrchestratorABI,
} as const;
